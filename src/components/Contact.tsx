...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-72 h-72 rounded-full border border-secondary/10 animate-rotate-slow" style={{ animationDirection: 'reverse' }} />

      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 scroll-reveal">
          <h2 className="text-5xl font-bold mb-4 font-noto-jp">
            <span className="text-gradient">一起合作 — Travaillons Ensemble</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Un projet en tête ? Une opportunité à discuter ? Je suis toujours ouvert aux nouvelles collaborations
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8 scroll-reveal">
            <div className="glass-card p-8 rounded-2xl hover-glow transition-all duration-500">
              <h3 className="text-2xl font-bold mb-6 text-gradient font-noto-jp">Informations de contact</h3>
          ...
          <div className="scroll-reveal">
            <div className="glass-card p-8 rounded-2xl hover-glow transition-all duration-500">
              <h3 className="text-2xl font-bold mb-6 font-noto-jp">Envoyez-moi un message</h3>

              <form ref={formRef} onSubmit={sendEmail} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="group">
                    <label className="text-sm font-medium mb-2 block group-focus-within:text-primary transition-colors">Nom</label>
                    <Input
                      name="name"
                  ...
                  <div className="group">
                    <label className="text-sm font-medium mb-2 block group-focus-within:text-primary transition-colors">Email</label>
                    <Input
                      type="email"
                      name="email"
                ...
                <div className="group">
                  <label className="text-sm font-medium mb-2 block group-focus-within:text-primary transition-colors">Sujet</label>
                  <Input
                    name="subject"
                ...
                <div className="group">
                  <label className="text-sm font-medium mb-2 block group-focus-within:text-primary transition-colors">Message</label>
                  <Textarea
                    name="message"
